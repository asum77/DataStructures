#GitHub link:https://github.com/asum77/DataStructures.git
#GitHub Username: asum77
import numpy as np
...
x = L/2
print()
print('(c) The point at which V=0 is {}'.format(x))#Question d
p = 0
s = 0.01
q = L + s
x = np.arange(p,q,s)
